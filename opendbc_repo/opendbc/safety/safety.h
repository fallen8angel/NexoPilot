...
static void generic_rx_checks(void) {
  ...
  // NEXO MED keeps steering authorization while the brake disables speed control.
  // Hyundai's TX hook separately requires inactive SCC and zero acceleration in MED.
